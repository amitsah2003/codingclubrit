  ...
  return (
    <div>
      <div className="py-10 px-4 md:px-10 lg:px-20 text-white h-full">
        <div className="flex flex-col items-center border border-gray-200 rounded-lg shadow md:flex-row md:border-0 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 h-full p-6">
          <div className="flex flex-col justify-between p-4 leading-normal text-center md:text-left">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-white dark:text-sky-800 px-2 py-2 font-serif">
              Join Our Family
            </h5>
          ...
          <div className="flex justify-center gap-5 mt-6 md:mt-0 md:ml-auto">
            ...
            >
              <Image
                ...
                height={100}
                width={100}
                className="w-14 md:w-16 lg:w-20 rounded-full"
              />
            </Link>
            <Link
              href={
